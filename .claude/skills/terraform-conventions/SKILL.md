...
description: Terraform style, security, modularity, and maintainability conventions. Covers sensitive-variable handling, module design, naming, formatting with terraform fmt/validate/tflint, documentation, and .tftest.hcl testing. Use when authoring or editing any *.tf file or reviewing a terraform change.
